...
class QueryHelper {
  ...
  static setDbProps (Model, op) {
    op.tableName = Model.dbProps('tableName');
  }

  static setDefaults (op) {
    if (!op.Constructor) {
      throw 'WARNING: No Constructor detected: defaults not set.';
    }
    op.attributes = Object.assign(op.Constructor.defaults(op), op.attributes);
  }
